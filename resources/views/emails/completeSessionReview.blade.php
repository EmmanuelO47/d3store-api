                        ...
                        <tbody style="line-height:inherit">
                            ...
                            <tr valign="top" style="line-height:inherit;border-collapse:collapse;vertical-align:top">
                                <td valign="top" style="line-height:inherit;border-collapse:collapse;word-break:break-word;vertical-align:top;font-family: 'Roboto',Arial,sans-serif;font-style: normal;font-weight: 400;font-size: 16px;line-height: 26px;color: #495057;padding: 0px 60px 20px;text-align: left;">
                                    ...
                                    <p style="margin:0;">Congratulations, on completing your 1-to-1 consultation program with {{ $consultationSessionUser->first_name }} {{ $consultationSessionUser->last_name }} today. We hope that you are satisfied with the session and would like you to write a review.</p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" valign="top">
                                                    <a href="{{ $url }}" style="display:block;background: #ED4763;border-radius: 5.06182px;font-family: 'Roboto',Arial,sans-serif;font-style: normal;font-weight: 500;font-size: 13px;line-height: 11px;text-align: center;color: #FFFFFF;text-decoration: none;white-space: nowrap;padding: 12px 42px;">Write a review</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
